...
def load_all_stats():
    ...
    # These will now show in your notebook
...
def compare_fg_percentage(regular_stats, playoff_stats, min_minutes=15):
    """Compares FG% between regular season and playoffs for players with enough minutes."""
...
def plot_fg_percentage_scatter(regular_stats, playoff_stats, min_minutes=15):
    """Creates an interactive scatter plot comparing regular season vs playoff FG%."""
    import plotly.graph_objects as go
    import numpy as np
